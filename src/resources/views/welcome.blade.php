            ...
            <div class="container">
                ...
                <div class="panel-group">
                    ...
                    @foreach($teams as $team)
                        ...
                        <div class="panel-heading"> <a href=" {{ route('welcomes.show',$team->id) }} ">{{$team->name}}</a></div>
                        <div class="panel-body"> <img src="/image/{{ $team->logoURL }}" width="100px"></div>
                        </div>
                    @endforeach 
                    @else
                    </p>No Team Added yet.Please login and add the team</p>
                    @endif                
